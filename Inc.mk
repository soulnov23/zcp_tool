...
ARFLAGS = -scurv
RANLIB = ranlib
FORMAT = clang-format --style="{BasedOnStyle: Google,AccessModifierOffset: -4,AlignConsecutiveAssignments: true,ColumnLimit: 130,UseTab: Never,IndentWidth: 4,TabWidth: 4}" -i

...
#define r_do4(func, p1, p2, p3, p4)                                       \
    ({                                                                    \
        ...
        while (ret_ == -1 && errno == EINTR) ret_ = func(p1, p2, p3, p4); \
        ret_;                                                             \
    })
...
#define r_do3(func, p1, p2, p3)                                       \
    ({                                                                \
        ...
        while (ret_ == -1 && errno == EINTR) ret_ = func(p1, p2, p3); \
        ret_;                                                         \
    })
...
#define r_do2(func, p1, p2)                                       \
    ({                                                            \
        ...
        while (ret_ == -1 && errno == EINTR) ret_ = func(p1, p2); \
        ret_;                                                     \
    })
...
#define r_do1(func, p1)                                       \
    ({                                                        \
        ...
        while (ret_ == -1 && errno == EINTR) ret_ = func(p1); \
        ret_;                                                 \
    })
...
#define r_do0(func)                                         \
    ({                                                      \
        ssize_t ret_ = func();                              \
        while (ret_ == -1 && errno == EINTR) ret_ = func(); \
        ret_;                                               \
    })

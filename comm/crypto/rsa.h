 ...
 * \param	sign_type  	\a sign 编码类型, 见\a upay::crypto::sign_code_type
...
int rsa_pubkey_decrypt(const std::string& cipher_in,  //密文
                          ...
                          int padding_mode_in, //TOOLS_RSA_NO_PADDING  TOOLS_RSA_PKCS1_PADDING   TOOLS_RSA_PKCS1_OAEP_PADDING
                          const std::string& pub_key_in,  //公钥
                          std::string& clear_data_out);  //明文

/*!
 * \fn int calculate_rsa_sign(const std::string& data_in, const std::string& private_key, int sign_type, std::string& sign)
